...
footer .contact li .c-p {
    font-size: 16px;
    color: #e5e5e5;
    font-family: var(--m), serif;
}

footer .contact li .c-p::after {
    display: none;
}
            ...
            <footer>
                <div class="f-c">
                    ...
                    <div class="contact">
                        <h2>Contact Us</h2>
                        <li>
                            <p class="c-p">+33-04-152-6371</p>
                        </li>
                        <li>
                            <p class="c-p">grossesbouchees@gmail.com</p>
                        </li>
                    </div>
                </div>
                <div class=" end">
                    &copy; <?php echo(date('Y')); ?> Grosses Bouchées, All Rights Reserved
                </div>
            </footer>
        </div>
    </section>
